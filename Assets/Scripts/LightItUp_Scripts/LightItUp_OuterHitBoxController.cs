...
public class LightItUp_OuterHitBoxController : MonoBehaviour
{
    public int score = 0;
                ...
                if(col.gameObject.tag == "note" && col.gameObject.name == noteHolder.transform.GetChild(0).name){
                    ...
                    if(zRotDiff < 45.0f){
                        ...
                        if(col.gameObject.name == "1"){
                            accuracyManager.GetComponent<AccuracyScript>().decrementHitNum();
    ...
    void OnTriggerEnter2D(Collider2D other){
        if(other.gameObject.name == "67" || other.gameObject.name == "197"){
        ...
        if(other.gameObject.name == "131" || other.gameObject.name == "261"){
            this.gameObject.transform.parent.GetChild(0).GetComponent<SpriteRenderer>().material = blueMat;
            CameraAnimator.SetTrigger("Shake_Intense");
        }       
        /*if(other.gameObject.name == "386" || other.gameObject.name == "394" || other.gameObject.name == "402"|| other.gameObject.name == "410"|| other.gameObject.name == "418"|| other.gameObject.name == "426"|| other.gameObject.name == "434"|| other.gameObject.name == "442"|| other.gameObject.name == "450"){
